...
const gatedNftFactory = new ethers.Contract(GATED_NFT_FACTORY, GatedNFTFactoryArtifact.abi, $signer)
...
<div class="max-w-prose flex flex-col gap-y-4">
    <div class="flex flex-col gap-y-2 mb-2">
        ...
        <span class="text-gray-400">
            Fill out the details below to configure a new gated ERC721. All tokens in the new ERC721 will be identical. These can then be minted by anyone who has the minimum tier status for the Tier contract you choose.
        </span>
    </div>
    <FormPanel heading="NFT token information">

        <Input type="text" bind:this={fields.name} validator={nameValidate} value="test nft">
        <span slot="label">
            Name:
        </span>
        </Input>

        <Input type="text" bind:this={fields.symbol} validator={symbolValidate} value="nft">
        <span slot="label">
            Symbol:
        </span>
        </Input>

        <Input type="text" bind:this={fields.description} validator={descriptionValidate} value="nft description">
        <span slot="label">
            Description:
        </span>
        </Input>
        ...
        <Input type="text" bind:this={fields.imageUrl} validator={imageUrlValidate} value="https://thumbs.dreamstime.com/b/gold-badge-5392868.jpg">
        <span slot="label">
            Image URL:
        </span>
        <span slot="description">
        ...
        <Input type="text" bind:this={fields.royaltyRecipient} validator={addressValidate} value={$signerAddress}>
        <span slot="label">
            Royalty recipient:
        </span>
        <span slot="description">
            The address that royalties will be paid to by supporting secondary marketplaces. Note that tokens that are "Non-transferrable" or "Gated transferrable" cannot be re-sold.
        </span>
        </Input>

        <Input type="number" bind:this={fields.royaltyPercent} validator={royaltyPercentValidate} value=10>
        <span slot="label">
            Royalty Percent:
        </span>
        </Input>
    ...
    <FormPanel heading="NFT minting/transferring rules">
        ...
        <Input type="number" bind:this={fields.maxMintable} validator={defaultValidator} value=10>
        <span slot="label">
            Maximum supply:
        </span>
        <span slot="description">
        ...
        <Input type="number" bind:this={fields.maxPerAddress} validator={defaultValidator} value=2>
        <span slot="label">
            Max per address:
        </span>
        <span slot="description">
        ...
        <Select items={transferrableOptions} bind:this={fields.transferrable} value=0>
            <span slot="label">
                Transferrable:
            </span>
            <span slot="description">
                Whether this GatedNFT is non-transferrable, transferrable to anyone, or only transferrable to other accounts that meet the same Tier requirements for minting.
            </span>
        </Select>

        <Input type="text" bind:this={fields.tier} validator={tierValidate} value="0xcd953b94999808ee07a33860dd46689580c90cf4">
        <span slot="label">
            Tier:
        </span>
        <span slot="description">
        ...
        <Input type="number" bind:this={fields.minimumStatus} validator={minimumStatusValidate} value=2>
        <span slot="label">
            Minimum Status:
        </span>
        </Input>
