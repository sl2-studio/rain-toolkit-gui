  ...
  {#if saleType !== null}
    ...
    <FormPanel>
      <div>
        ...
        <br />
        <span class="text-gray-400"
          >If switched on, only the sale creator can start/end the sale once the
          canEnd/Start criteria of the sale is met.</span
        >
      </div>
    </FormPanel>
    ...
    <FormPanel>
      <div>
        ...
        <br />
        <span class="text-gray-400"
          >Specify extra time for the sale that can continue for, if the raised
          amount reaches a certain amount before the sale's normal end time.</span
        >
      </div>
      <div
        id="exTime"
      ...
      >
        ...
        <div id="exDis" style="display:none">
          ...
          >
            ...
            <span slot="description">
              Amount that each wallet had to be purchased to be eligible for the
              extra time discount.</span
            >
          </Input>
        </div>
      </div>
            ...
            <tr class="grid w-full grid-cols-2 gap-x-4">
              ...
              <td>
                ...
                <sapn class="text-gray-400"
                  >Duration of time tier must be held for the perk to activate.</sapn
                >
              </td>
            </tr><br />
            <tr class="grid w-full grid-cols-2 gap-x-4">
    ...
    <FormPanel>
      ...
      <div id="tierCapMul" style="display:none" class="w-full">
        ...
        >
          <span slot="label">Tier Contract Address: </span>
          <span slot="description">
            The address of the tier contract you want to provide the max wallet
            cap multiplier for.
          </span>
        </Input>
        <br /><br />
          ...
          <table>
            <tr class="grid w-full grid-cols-2 gap-x-4">
              <td>
                ...
                <br />
                <span class="text-gray-400"
                  >Multiplier for max cap per wallet for holding a certain teir.</span
                >
              </td>
              <td>
    ...
    <FormPanel heading="RedeemableERC20 config">
      ...
      >
        ...
        <span slot="description">
          ...
          raise is 0, this must be set to something other than the zero address.
        </span>
      </Input>
